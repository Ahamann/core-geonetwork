...
function prepareData(xml,children){   
   ...
   //JSON Object -pure without ectra lineage or usage datasets
    ...
    //parent check
    parent="";   //loop if more prants are possible
    ...
    for(var j = 0;j<childrenArray.length-1;j++){
        ...
        readXML(domain+childrenArray[j], function(err, response) { // pass an anonymous function
            ...
            if (err) {
                ...
                console.log("IN");
                xmlKiddy=response;
                jsonObject["dataset_data"][childrenArray[j]]={
                "keywords": "keywords",
                "save": xmlKiddy.getElementsByTagNameNS(gmd,"linkage")[0].getElementsByTagNameNS(gmd,"URL")[0].innerHTML,
                ...
                "time": xmlKiddy.getElementsByTagNameNS(gml,"beginPosition")[0].innerHTML +" - "+ xml.getElementsByTagNameNS(gml,"endPosition")[0].innerHTML,
                "extent": "180,-90;-180,-90;-180,90;180,90",
